...
def generate_snapshot_comparison_report(models, layer_type=None, layer_order=0, ref_idx=None):
    """
    ...
    for part in range(parts):
        if layer_type:
            ...
            tmp_layer_weights, _, _ = comparison_tools.get_weights_for_layer(examined_layer)
            layer_weights[part] = [tmp_layer_weights]
        else:
